# -*- coding: utf-8 -*-
"""
Created on Sat Dec 21 20:52:14 2024
...
class SRenv():
    ...
    def __init__(self, num_episode=1,
        ...
        self.accumulated_x_error = 0
        self.accumulated_y_error = 0
        ...
        with ThreadPoolExecutor(max_workers=self.rudder_worker_num, 
            ...
            while self.simulation_running:
                ...
                if x_prev is None:
                    ...
                    delta_x = x - x_prev
                    delta_time = current_time - prev_time + 0.0001
                    x_rate = delta_x / delta_time
                    
                    x_prev = x
                    prev_time = current_time
                
                rudder_pwm = (-x * P2 - x_rate * D2 - self.accumulated_x_error * I2) * Kr
    ...
    def elevator_function(self):
        ...
        with ThreadPoolExecutor(max_workers=self.elevator_worker_num, 
            ...
            while self.simulation_running:
                ...
                elevator_pwm = -y * P2 - y_rate * D2 - self.accumulated_y_error * I2
...
# """
                ...
                # print(f'x: {coor_target_center_x}\ny: {coor_target_center_y}\n\n')
