# -*- coding: utf-8 -*-
"""
Created on Sat Feb 22 18:34:59 2025
...
not yet finished. the object detected part has not been integrated with the control system
"""
...
import win32gui
import cv2
from src.srvision import draw_distance, draw_crosshair
        ...
        with ThreadPoolExecutor(max_workers=self.rudder_worker_num, 
            ...
            while self.simulation_running:
                ...
                if self.waypoints[0][0] is not None:
                    ...
                    #     self.distance_to_target = self.distance_to_waypoint
