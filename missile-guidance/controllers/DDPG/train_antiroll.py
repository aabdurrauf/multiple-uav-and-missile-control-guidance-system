        ...
        for ep in t:
            ...
            for _ in range(MAX_STEP):
                ...
                cur_act = brain.act(
                    ...
                    _notrandom= True, # full exploitation
                    # (
                    #     (ep >= warm_up)
                    #     and
                    #     (
...
if __name__ == "__main__":
    ...
    load_checkpoints_path = 'ddpg/saved_models/20241102-082455/20241102-082455' # load the latest
    
    train(checkpoints_path=f'{checkpoint_dir}/{model_name}', 
          load_checkpoints_path=load_checkpoints_path, 
          warm_up=WARM_UP, eps_greedy=1.0, 
